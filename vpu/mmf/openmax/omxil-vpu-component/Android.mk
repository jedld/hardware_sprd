...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/src		\
			...
			$(TOP)/hardware/sprd/vpu/mmf/openmax/libomxil-bellagio-0.9.3/src \
			$(TOP)/hardware/sprd/vpu/mmf/openmax/libomxil-bellagio-0.9.3/src/base \
			$(TOP)/hardware/sprd/vpu \
			$(TOP)/hardware/sprd/vpu/vpuapi \
